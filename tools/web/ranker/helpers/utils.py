...
# Module-level convenience logger for modules that expect `logger`
logger = get_logger("ranker")


def robust_json_parser(s: str) -> Optional[Any]:
    ...
    # Find first JSON-like substring by scanning for matching braces/brackets
    ...
    # Fallback: regex extract first {...} or [...] block
